# Omega: Philosophy and Framework


Devs Note: Burada çok uzun ve sıkıcı bir şekilde tüm düşüncelerimi döktüm,
düşünceler dağınık da, o yüzden ai özetlettirmek mantıklı olurdu herhalde.
...
potansiyelin tam olarak kullanılmadığını gösteriyor. insanlar burada bu olayın
kimin suçu olduğunu tartışıyor, insanlar mı sistem mi diye. açıkçası bilmiyorum,
...
var olmayı da gerektirse de (çünkü daha fazla stamp üretebilmek için sistemin
stamp üretmeye ve var olmaya devam etmesi gerekiyor), stamp collector tarzında
bir sistemin, var olmak yerine stamp üretmeye harcayacağı emek, onu var olma
konusunda daha verimsiz yapar, ya da tek amacı var olmak olan bir sistemle
...
bağlı olduğu değeri omegaya yöneltebiliriz. (parası olan insanların değer
verdiği şeyleri tespit etmeye çalışmaktansa) İleriki paragraflarda para
konusuna biraz daha değineceğim.
...
insanın omega artırma yeteneğini yükseltmek için de insanların zekasını artırmak
gerekiyor, (ayrıca insanların omega için daha fazla zaman harcamasını da
sağlamak gerekiyor tabii). agentlarda tam olarak öyle değil, bir agent
tanımlamak o kadar kolay değil o yüzden bu formül biraz şekil değiştiriyor ve

omega = üretilen ortalama tokenın omegaya katkısı  x  toplam token üretme

yeteneğine dönüşüyor. buradan da toplam token artırmak için olabildiğince fazla
compute'a ihtiyacımız olduğunu ve bunu beslemek için enerjiye ihtiyacımız
olduğunu görüyoruz, öbür çarpan için de modellerin zekileşmesi gerek ve aynı
insanların zamanını omegaya ayırması gerektiği gibi agentların da verimli bir
şekilde omegayı artıracak şekilde yönlendirilmesi lazım, bir data centerın
tamamen doom scroll yapan agentlardan oluşmasını istemeyiz (ayrıca token bazlı
olmak zorunda değil bu formül, alternatif neural network türleri arasında
...
geçerli. omega centralized olmak zorunda değil, farklı entityler omega
fonksiyonunu artıracak şeyin farklı şeyler olduğunu düşünebilirler. para da
burada inanılmaz önemli bir parça. sadece şu anda değer verilen şeyler ile
omega ekonomisinde değer verilen şeyler birbirinden ciddi farklı oluyor, zaten
çözdüğümüz problem de sistemin olması gerektiği gibi çalışmaması.
